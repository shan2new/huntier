      ...
      <div className="relative flex w-full items-center space-x-2">
        <div className="relative flex-1">
          <textarea
            ...
            {...(() => {
              const { allowAttachments: _aa, files: _files, setFiles: _sf, accept: _ac, ...rest } = props as any
      ...
      <div className="absolute right-3 top-3 z-20 flex gap-2">
        {props.allowAttachments && (
          <Button
            ...
            onClick={async () => {
              const files = await showFileUploadDialog(accept)
              addFiles(files)
            }}
          >
...
function showFileUploadDialog(accept?: string) {
